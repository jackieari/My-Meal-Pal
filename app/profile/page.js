...
export default function ProfilePage() {
  ...
  return (
    <div className="flex flex-col items-center min-h-screen bg-gray-100 dark:bg-gray-950 text-gray-900 dark:text-gray-100 p-4 md:p-8 pt-40">
      {/* Header */}
      <header className="fixed top-0 left-0 right-0 z-40 w-full border-b border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 shadow-md">
            ...
            {showCalorieCalculator && (
              <div className="space-y-4 pt-2 border-t border-gray-300 dark:border-gray-700">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {/* Gender */}
                  <div>
                    <label htmlFor="gender" className="block mb-2 text-sm font-medium text-gray-800 dark:text-gray-200">
                      Gender
                    </label>
                    <select
                      id="gender"
