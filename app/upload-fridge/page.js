...
export default function FridgeUploadPage() {
  ...
  return (
      <div className="min-h-screen bg-gray-100 dark:bg-gray-950 text-gray-900 dark:text-gray-100">
        {/* Header */}
        <header
            className="sticky top-0 z-40 w-full border-b border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 shadow-md">
        ...
        <main className="container mx-auto px-4 py-8">
          ...
          <div className="mb-12 text-center">
            ...
            <p className="text-gray-700 dark:text-gray-300 max-w-xl mx-auto">Select an image of your fridge contents for
              analysis</p>
          </div>
          ...
          {selectedImage && (
              <div
                  className="mb-6 bg-white dark:bg-gray-900 rounded-xl p-6 shadow-md border border-gray-300 dark:border-gray-700">
                <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Selected Image</h2>
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                  <div
                      className="relative w-full sm:w-48 h-48 rounded-lg overflow-hidden border border-gray-300 dark:border-gray-700">
                    <Image
